...
{
    [SerializeField] SurfaceConfig config = null;
    ...
    public BiVector3 CalculateForces(Vector3 worldAirVelocity, float airDensity, Vector3 relativePosition)
    {
        ...
        // Calculating air velocity relative to the surface's coordinate system. Z component of the velocity is discarded. 
...
#if UNITY_EDITOR
    // For gizmos drawing.
    public SurfaceConfig Config => config;
